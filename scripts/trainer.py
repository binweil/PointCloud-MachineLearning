...
PACKAGE_PATH = "/home/lamy/Desktop/scripts" #rospack.get_path('robot_vision')
...
class trainModel():
    ...
    def run(self):
        d = DataHandler()
        g = GASD()
        BASE_PATH = "/home/lamy/Downloads/Dataset_RGBD"
        #CLASS_PATH = ["apple_1","banana_1","bowl_1","calculator_1","coffee_mug_1"]
        CLASS_PATH = ["apple_1","banana_1","bowl_1","calculator_1","car_1"]
        train_flag = True
        ...
        for i in range(2):
            ...
            data = d.load_raw_file(BASE_PATH = "/home/lamy/Downloads/Dataset_RGBD",CLASS_PATH=query_class,file_name=query_file)
